...
#Change path to run 
ratings = panda.read_csv('/home/ashwin/Documents/smai project/ml-100k/u.data', sep='\t', names=r_cols, usecols=range(3))

m_cols = ['movie_id', 'title']
#Change path to run
movies = panda.read_csv('/home/ashwin/Documents/smai project/ml-100k/u.item', sep='|', names=m_cols, usecols=range(2))
